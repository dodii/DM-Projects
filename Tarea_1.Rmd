...
El dataset "data_tf" tiene 327 filas y 113 columnas.
```{r}
dim(data_tf)
```
...
Cada fila describe los resultados de cada encuentro local autoconvocado, cada columna representa la cantidad de veces que apareció un concepto respondiendo a alguna de las preguntas de la ELA. En particular, la fila 85 muestra los resultados del ELA en la ciudad de Andacollo, ubicada en la provincia de Elqui, perteneciente a la región de Coquimbo; y a primera vista se observa que se mencionaron como derechos: la educación, la integridad física y psiquica, la nacionalidad, la salud, etc...
```{r}
data_tf[85,]
```
